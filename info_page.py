...
with col_info2:
    ...
    * **Datahantering:** Datan hämtas för lagring i en SQLite databas. Detta görs för att möjliggöra snabbare och mer stabil åtkomst för analysen.
    """)
...
st.info(
    ...
    **Gå till sidan 'Tidsresan'** i menyfliken till vänster eller uppdatera databasen och gå vidare genom att klicka nedan för att starta 
    tidsresan. Använd tidsreglaget för att se hur världen – och din portfölj – förändrades, månad för månad.
